 ...
 * @since 2017-11-09
 */
@TableName("tk_ticket_acceptance_item")
public class TicketAcceptanceItem extends Model<TicketAcceptanceItem> {
    ...
    public TicketAcceptanceItem setId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public TicketAcceptanceItem setTicketId(Long ticketId) {
    ...
    public TicketAcceptanceItem setEquipmentId(Long equipmentId) {
    ...
    public TicketAcceptanceItem setEquipmentNumber(String equipmentNumber) {
    ...
    public TicketAcceptanceItem setEquipmentCode(String equipmentCode) {
    ...
    public TicketAcceptanceItem setEquipmentName(String equipmentName) {
    ...
    public TicketAcceptanceItem setEquipmentUnit(String equipmentUnit) {
    ...
    public TicketAcceptanceItem setEquipmentSpec(String equipmentSpec) {
    ...
    public TicketAcceptanceItem setWarehouseId(Long warehouseId) {
    ...
    public TicketAcceptanceItem setWarehouseName(String warehouseName) {
    ...
    public TicketAcceptanceItem setWhWarehouseAreaId(Long whWarehouseAreaId) {
    ...
    public TicketAcceptanceItem setWhWarehouseAreaName(String whWarehouseAreaName) {
    ...
    public TicketAcceptanceItem setWhWarehouseSlotId(Long whWarehouseSlotId) {
    ...
    public TicketAcceptanceItem setWhWarehouseSlotName(String whWarehouseSlotName) {
