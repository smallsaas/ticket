 ...
 * @since 2017-11-09
 */
@TableName("tk_ticket_execution_item")
public class TicketExecutionItem extends Model<TicketExecutionItem> {
    ...
    public TicketExecutionItem setId(Long id) {
        this.id = id;
        return this;
    }
    ...
    public TicketExecutionItem setTicketId(Long ticketId) {
    ...
    public TicketExecutionItem setEquipmentId(Long equipmentId) {
    ...
    public TicketExecutionItem setEquipmentNumber(String equipmentNumber) {
    ...
    public TicketExecutionItem setEquipmentCode(String equipmentCode) {
    ...
    public TicketExecutionItem setEquipmentName(String equipmentName) {
    ...
    public TicketExecutionItem setEquipmentUnit(String equipmentUnit) {
    ...
    public TicketExecutionItem setEquipmentSpec(String equipmentSpec) {
    ...
    public TicketExecutionItem setWarehouseId(Long warehouseId) {
    ...
    public TicketExecutionItem setWarehouseName(String warehouseName) {
    ...
    public TicketExecutionItem setWhWarehouseAreaId(Long whWarehouseAreaId) {
    ...
    public TicketExecutionItem setWhWarehouseAreaName(String whWarehouseAreaName) {
    ...
    public TicketExecutionItem setWhWarehouseSlotId(Long whWarehouseSlotId) {
    ...
    public TicketExecutionItem setWhWarehouseSlotName(String whWarehouseSlotName) {
