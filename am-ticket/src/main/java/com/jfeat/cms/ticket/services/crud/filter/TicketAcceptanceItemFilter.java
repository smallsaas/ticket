 ...
 */
public class TicketAcceptanceItemFilter implements CRUDFilter<TicketAcceptanceItem> {

    private String[] ignoreFields = new String[]{};
    private String[] updateIgnoreFields = new String[]{};

    @Override
    public void filter(TicketAcceptanceItem entity, boolean insertOrUpdate) {
